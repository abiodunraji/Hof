  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-foreground to-gray-900 text-white py-12 px-4 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="border-t border-magenta/20 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} House of Faridah. All rights reserved.</p>
          <p className="flex items-center gap-1 mt-4 md:mt-0">
            Designed with <Heart size={16} className="text-primary" fill="currentColor" /> by Faridah
          </p>
        </div>
      </div>
    </footer>
