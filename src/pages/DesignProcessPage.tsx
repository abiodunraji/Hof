            ...
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="bg-white/90 hover:bg-white text-primary border-2 border-white shadow-lg"
                >
                ...
                <Button
                  asChild
                  size="lg"
                  className="bg-gradient-to-r from-hot-pink to-magenta-dark text-white hover:from-magenta-light hover:to-magenta border-0 shadow-lg"
                >
